...
export const tradingConfig = {
    ...
    SPREAD_MIN_BASE_VALUE: parseFloat(process.env.SPREAD_MIN_BASE_ASSET_TRADE_VALUE!),
    SPREAD_MIN_QUOTE_VALUE: parseFloat(process.env.SPREAD_MIN_QUOTE_ASSET_TRADE_VALUE!),
